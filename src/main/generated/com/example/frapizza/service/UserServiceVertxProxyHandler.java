...
public class UserServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "save": {
          service.save((io.vertx.core.json.JsonObject)json.getValue("userJson"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "update": {
          service.update((io.vertx.core.json.JsonObject)json.getValue("userJson"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "delete": {
          service.delete((java.lang.String)json.getValue("id"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "readById": {
          service.readById((java.lang.String)json.getValue("id"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "readAll": {
          service.readAll(HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
